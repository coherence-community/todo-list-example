...
```bash
java -jar target/todo-list-spring-server-21.12.1.jar
```
...
```bash
java -jar target/todo-list-spring-server-21.12.1.jar --spring.profiles.active=coherence
```
...
ghcr.io/coherence-community/todo-list-spring-server   21.12.1     418e5870adc9   5 minutes ago    275MB
